...
$authentik_oidc_enabled = intval($row['config_oidc_authentik_enabled'] ?? 0);
$authentik_oidc_button_text = nullable_htmlentities($row['config_oidc_authentik_button_text'] ?? 'Login with Authentik');
$authentik_oidc_key_suffix = $config_login_key_required ? '&key=' . urlencode($config_login_key_secret) : '';
...
<div class="login-box">
 ...
 <!-- N45-AUTHENTIK-OIDC-LOGIN-BUTTON -->
 <?php if ($authentik_oidc_enabled) { ?>

 <div class="col text-center mt-2">
 <a href="agent/openid_login.php<?php echo $authentik_oidc_key_suffix; ?>">

 <button type="button" class="btn btn-secondary btn-block"><?php echo $authentik_oidc_button_text; ?></button>
